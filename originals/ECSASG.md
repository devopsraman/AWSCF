 ...
 * **AWSRegionArch2AMI**:
  * `(u'us-east-1', {u'64': u'ami-3d55272a'})`
  * `(u'ap-northeast-1', {u'64': u'ami-096cba68'})`
  * `(u'ap-southeast-1', {u'64': u'ami-7934ee1a'})`
  * `(u'ap-southeast-2', {u'64': u'ami-22a49541'})`
  * `(u'us-west-2', {u'64': u'ami-1ccd1f7c'})`
  * `(u'us-west-1', {u'64': u'ami-444d0224'})`
  * `(u'eu-central-1', {u'64': u'ami-f562909a'})`
  * `(u'eu-west-1', {u'64': u'ami-b6760fc5'})`
