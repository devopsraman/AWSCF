 ...
 * **AWSRegionArch2AMI**:
  * `(u'ap-south-1', {u'64': u'ami-43fd882c'})`
  * `(u'us-east-1', {u'64': u'ami-7d7f026a'})`
  * `(u'ap-northeast-1', {u'64': u'ami-1efc2d7f'})`
  * `(u'ap-southeast-2', {u'64': u'ami-2a9eaf49'})`
  * `(u'eu-west-1', {u'64': u'ami-ea84fd99'})`
  * `(u'ap-southeast-1', {u'64': u'ami-be5389dd'})`
  * `(u'ap-northeast-2', {u'64': u'ami-3323f65d'})`
  * `(u'us-west-2', {u'64': u'ami-8505d7e5'})`
  * `(u'us-west-1', {u'64': u'ami-576c2337'})`
  * `(u'eu-central-1', {u'64': u'ami-a947b5c6'})`
  * `(u'sa-east-1', {u'64': u'ami-a02bbbcc'})`
