Windows2012r2AutorecoveryWithTeamcity FAWS Template
===================================================
windows_2012R2_autorecovery_with_teamcity.template - AutoRecovery EC2 Instance. **WARNING** You will be billed for the AWS resources used if you create a stack from this template.
### Parameters
