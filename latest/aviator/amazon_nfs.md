AmazonNfs FAWS Template
=======================
amazon_nfs.template - AutoRecovery EC2 Instance. **WARNING** You will be billed for the AWS resources used if you create a stack from this template.
### Parameters
