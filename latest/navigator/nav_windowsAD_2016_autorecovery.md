NavWindowsad2016Autorecovery FAWS Template
==========================================
nav_windowsAD_2016_autorecovery.template - AutoRecovery EC2 Instance. **WARNING** You will be billed for the AWS resources used if you create a stack from this template.
### Parameters
