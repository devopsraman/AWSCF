NavWindowsad2012r2Autorecovery FAWS Template
============================================
nav_windowsAD_2012R2_autorecovery.template - AutoRecovery EC2 Instance. **WARNING** You will be billed for the AWS resources used if you create a stack from this template.
### Parameters
